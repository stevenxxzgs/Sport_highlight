...
# # 将时间戳添加到文件名中
# filename1 = f"cam3_{time_string}.mp4"
...
capture = cv2.VideoCapture("rtsp://admin:xu123456@192.168.1.253:554/cam/realmonitor?channel=1&subtype=0")
...
def read_frames(capture, frames, recording_time):
    ...
    while time.time() - start_time < recording_time:
        ...
        if not ret:
            break
        frames.append(frame[:1000, 250:1750, :])
